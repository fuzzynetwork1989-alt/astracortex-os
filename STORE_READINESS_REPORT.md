...
_Generated 2026-08-20T09:43:44+00:00Z by store_autopilot.py_

**Score: 17/23 applicable checks passed** (0 not applicable to this repo)
...
- [PASS] App icon asset present
- [PASS] Screenshots folder / capture plan present
- [PASS] CHANGELOG for release notes

## Mobile Build Config

- [PASS] app.json has iOS bundleIdentifier + Android package
- [PASS] app.json declares version + versionCode/buildNumber
- [PASS] EAS build config (eas.json) present for Expo app
- [MISSING] iOS privacy usage-description strings present where permissions are used
